# @taktikorg/impedit-architecto-ab

[![Published on webcomponents.org](https://img.shields.io/badge/webcomponents.org-published-blue.svg)](https://www.webcomponents.org/element/owner/@taktikorg/impedit-architecto-ab)

provide SPA route's experience with native web component

[Online Demo](https://@taktikorg/impedit-architecto-ab.vercel.app/)

## Installation

`pnpm install @taktikorg/impedit-architecto-ab`
...
```typescript
import { preload } from '@taktikorg/impedit-architecto-ab';
preload();
```
...
```typescript
import { redirect } from '@taktikorg/impedit-architecto-ab';
// ...
redirect('/', '/other/path');
// ...
```
...
![Online Demo]([https://](https://@taktikorg/impedit-architecto-ab.vercel.app/))
